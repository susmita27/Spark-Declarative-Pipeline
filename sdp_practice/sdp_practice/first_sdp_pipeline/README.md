...
This folder defines all source code for the 'first_sdp_pipeline' pipeline:
...
* Take a look at the sample under "sample_users_first_sdp_pipeline.py" to get familiar with the syntax.
